...
if ($user_id) {
    $query = $conn->prepare("SELECT * FROM lecturers WHERE user_id = ?");
...
<div class="card">
  <div class="profile-section">
    ...
    <div class="form-section">
      ...
      <form method="POST" action="lecsubmit.php" enctype="multipart/form-data">
      ...
      <?php else: ?>
        ...
        <div style="text-align:left;">
          <p><strong>Name:</strong> <?= htmlspecialchars($lecturer['first_name']) ?> <?= htmlspecialchars($lecturer['last_name']) ?></p><br>
          <p><strong>Email:</strong> <?= htmlspecialchars($lecturer['email']) ?></p><br>
          <p><strong>Faculty:</strong> <?= htmlspecialchars($lecturer['faculty_name']) ?></p><br>
          <p><strong>Course:</strong> <?= htmlspecialchars($lecturer['course_taught']) ?></p><br>
           <p><strong>Unit:</strong> <?= htmlspecialchars($lecturer['unit_taught']) ?></p><br>
        </div>
        <form method="GET" action="edit_lec_profile.php">
